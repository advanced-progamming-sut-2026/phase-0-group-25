...
import com.test1.PlantsVsZombies.src.Model.Quests.QuestSubclasses.*;
...
public class QuestDefinitionLoader {
    public static List<Quest> loadQuests() {
        ...
        quests.add(new OnlyCactusQuest("only_cactus", QuestCategory.DAILY, QuestPriority.HIGH, true, QuestPage.ZOMBIE_SLAYER));
