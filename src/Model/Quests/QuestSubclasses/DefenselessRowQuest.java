...
public class DefenselessRowQuest extends Quest {
    ...
    public DefenselessRowQuest(String id, String name, String description,
                               QuestCategory category, QuestPriority priority,
                               List<Reward> rewards, Map<String, Object> conditions,
                               boolean dailyReset, QuestPage page, int row) {
    ...
    public void check(Event event) {
        ...
        if (emptyRows != null && emptyRows.length > targetRow && emptyRows[targetRow]) {
            incrementProgress(1);
        }
    }
}